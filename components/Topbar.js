        ...
        <div className="bg-gray-900  text-gray-100 hidden lg:block">
            <div className="flex lg:px-10 mx-auto justify-between items-center py-2">
                <ul className={`flex items-center space-x-4`}>
                    <li className="inline-flex items-center">
                        <Link className="text-xs" href="https://www.facebook.com">
                            <svg
                                ...
                                className={`svg-inline--fa fa-facebook-f size-4`}
                                role="img"
                    ...
                    <li className="inline-flex items-center">
                        <Link className="text-xs" href="https://www.instagram.com" aria-label="Haru Fashion Instagram Account">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fab"
                                data-icon="instagram"
                                className={`svg-inline--fa fa-instagram size-4`}
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512"
                                height="16"
                ...
                <ul className={`flex items-center space-x-4`}>
                    ...
                    <li className="inline-flex items-center">
                        <Link href="policy" className="text-xs">Our Policy</Link>
                    </li>
                </ul>
            </div>
        </div>
